...
import { getKnowledgeHomeData, type KnowledgeArticle, type KnowledgeCategoryKey } from '@/lib/knowledge-service'
import { getSourcePlatformMeta } from '@/lib/knowledge-meta'
...
const loadKnowledgePage = createServerFn().handler(async () => {
...
function KnowledgePage() {
  const { data, canCreateKnowledge } = Route.useLoaderData()
